module.exports = function(config) {
  ...
  var fontAssets  = '/base/assets/stylesheets/'; // Where our fonts will be located (karma proxy)
  var htmlAssets  = '/base/assets/templates/'; // Where our fonts will be located (karma proxy)
